 ...
 */
declare function createState(context: SpinalContext, name: string, model: Object, dbIds: Array<Number>): SpinalNode;
/**
 ...
 */
declare function createRecord(context: SpinalContext, model: Object, validDbIds: Array<Number>, invalidDbIds: Array<Number>): SpinalNode;
